...
class Vector 
{
    public:
        ...
        Vector(const LMPoint* p1, const LMPoint* p2) { x = p2->x-p1->x; y = p2->y-p1->y; z = p2->z-p1->z; }
        
        void set(float nx, float ny, float nz) { x=nx; y=ny; z=nz; }        
        void set(const LMPoint* p1, const LMPoint* p2) { x = p2->x-p1->x; y = p2->y-p1->y; z = p2->z-p1->z; }
        ...
        LMPoint closestPoint(const LMPoint* start, const LMPoint* object) const;        
        LMPoint closestNormalisedPoint(const LMPoint* start, const LMPoint* finish, const LMPoint* object) const;
...
inline LMPoint Vector::closestPoint(const LMPoint* start, const LMPoint* object) const
{
...
inline LMPoint Vector::closestNormalisedPoint(const LMPoint* start, const LMPoint* finish, const LMPoint* object) const
{
    Vector v2(object->x-start->x,object->y-start->y,object->z-start->z);
