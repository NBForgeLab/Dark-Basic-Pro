...
DARKSDK void ExtractFileFromBlock               ( int iID, const char* szFilename, const char* szPath );

DARKSDK int  GetFileBlockNumFiles				( int iID );
DARKSDK const char* GetFileBlockFileName		( int iID, unsigned int index );
DARKSDK const char* const* GetFileBlockAllFileNames	( int iID );
DARKSDK const unsigned long* GetFileBlockAllFileSizes ( int iID );
