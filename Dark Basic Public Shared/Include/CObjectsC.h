...
DARKSDK void ChangeObjectFrame		(int iID, float fFrame);
...
DARKSDK void SetObjectInterpolation	( int iID, float fInterp );
...
DARKSDK void			CalculateObjectFrameBounds (int iID, float fFrame);
...
DARKSDK void RotateObjectQuat( int iID, float fQX, float fQY, float fQZ, float fQW );
