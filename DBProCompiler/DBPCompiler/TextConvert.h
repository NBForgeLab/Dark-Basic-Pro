...
public:
    ...
    static std::wstring UTF8ToUTF16(const std::string& utf8Str) {
        ...
        int size_needed = MultiByteToWideChar(CP_UTF8, 0, &utf8Str[0], (int)utf8Str.size(), nullptr, 0);
    ...
    static std::string UTF16ToUTF8(const std::wstring& utf16Str) {
        ...
        int size_needed = WideCharToMultiByte(CP_UTF8, 0, &utf16Str[0], (int)utf16Str.size(), nullptr, 0, nullptr, nullptr);
        std::string strTo(size_needed, 0);
        WideCharToMultiByte(CP_UTF8, 0, &utf16Str[0], (int)utf16Str.size(), &strTo[0], size_needed, nullptr, nullptr);
        return strTo;
    }
};
